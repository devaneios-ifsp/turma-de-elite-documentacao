...
% Dedicatória
\input{EntregaInicialCopia/pre-dedicatoria}
% ---

% Agradecimentos
\input{EntregaInicialCopia/pre-agradecimentos}
% ---

% Epígrafe
\input{EntregaInicialCopia/pre-epigrafe}
% ---

% -- resumo obrigatório
\input{EntregaInicialCopia/pre-resumos}
...
% ---
\input{EntregaInicialCopia/pre-siglas}
...
\input{EntregaInicialCopia/textos-introducao}
\input{EntregaInicialCopia/textos-revisao-literatura}
\input{EntregaInicialCopia/textos-gerenciamento-projeto}
\input{EntregaInicialCopia/textos-desenvolvimento-projeto}
\input{EntregaInicialCopia/textos-consideracoes-finais}
...
\input{EntregaInicialCopia/pos-glossario}
\input{EntregaInicialCopia/pos-apendices}
