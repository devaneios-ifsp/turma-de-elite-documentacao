...
\newglossaryentry{coding-convention}{
                name={coding convention},
                plural={coding conventions},
                description={Convenções de codificação, um conjunto de diretrizes para uma linguagem de programação específica que recomenda estilo, práticas e métodos de programação para cada aspecto de um programa escrito nessa linguagem}  
}
...
\newglossaryentry{feedback}{
                name={feedback},
                plural={feedbacks},
                description={Dar uma resposta a uma atitude ou comportamento, dar um retorno}
}
...
\newglossaryentry{mobile}{
                name={mobile},
                plural={mobile},
                description={Tecnologia direcionada ou adaptada para dispositivos móveis, como \textit{smartphones} e \textit{tablets}}
}
...
\newglossaryentry{open-banking}{
                name={Open Banking},
                plural={Open Banking},
                description={Conjunto de regras e tecnologias que permite o compartilhamento de dados e serviços de clientes entre instituições financeiras por meio da integração de sistemas}
}
...
\newglossaryentry{reset}{
                name={reset},
                plural={resets},
                description={reiniciar, \textit{resetar}}
}
