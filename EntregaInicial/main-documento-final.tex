...
% Dedicatória
\input{EntregaInicial/pre-dedicatoria}
% ---

% Agradecimentos
\input{EntregaInicial/pre-agradecimentos}
% ---

% Epígrafe
\input{EntregaInicial/pre-epigrafe}
% ---

% -- resumo obrigatório
\input{EntregaInicial/pre-resumos}
...
% ---
\input{EntregaInicial/pre-siglas}
...
\input{EntregaInicial/textos-introducao}
\input{EntregaInicial/textos-revisao-literatura}
\input{EntregaInicial/textos-gerenciamento-projeto}
\input{EntregaInicial/textos-desenvolvimento-projeto}
\input{EntregaInicial/textos-consideracoes-finais}
...
\input{EntregaInicial/pos-glossario}
\input{EntregaInicial/pos-apendices}
